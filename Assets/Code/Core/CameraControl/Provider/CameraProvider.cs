...
namespace Code.Core.CameraControl.Provider
{
    public class CameraProvider : ICameraProvider
    {
        ...
        public void PlayCinematicMoveTo(Vector3 endPosition, float delayOnTargetDuration, Action onMoveCompleted = null,
            Action onDelayCompleted = null)
        {
            _cameraMovement.CinematicMoveToPosition(endPosition, delayOnTargetDuration, onMoveCompleted,
                onDelayCompleted);
        }
