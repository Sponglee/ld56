...
//todo: add initialize method where be initialize view and model
    public class CameraMovementPresenter : ICameraMovementPresenter
    {
        ...
        public void CinematicMoveToPosition(Vector3 endPosition, float delayOnTarget, Action onMoveCompleted = null,
            Action onDelayCompleted = null)
        {
        ...
        private void InitializeView(ITickHandler tickHandler)
        {
            _view.Initialize(this);
            _view.InitializeDependencies(tickHandler);
        }

        private void CinematicMoveToPositionProcess(Vector3 endPosition, float delayOnTargetDuration,
            Action onMoveCompleted = null, Action onDelayCompleted = null)
        {
            _model.OnCinematicStepStarted();
            CinematicStarted?.Invoke();
