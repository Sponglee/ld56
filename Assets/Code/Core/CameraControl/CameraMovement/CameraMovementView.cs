...
namespace Code.Core.CameraControl.CameraMovement
{
    public class CameraMovementView : CameraMovementViewBase
    {
        ...
        [field: SerializeField] public override Camera GameplayCamera { get; protected set; }
        [field: SerializeField] public override Camera CutsceneCamera { get; protected set; }
        ...
        public override void InitializeDependencies(ITickHandler tickHandler)
        {
        ...
        public override void CinematicMoveToTarget(Vector3 targetPosition, float moveToTargetDuration,
        ...
        public override void ReturnCinematicCamera(float returnDuration)
        {
            ...
            _cinematicMoveCameraSequence.Append(_activeCameraTransform.DOMove(followTargetPosition, returnDuration)
